...
const TesterDash: React.FC<TesterDashProps> = ({
  ...
  return (
    ...
    >
      ...
      <motion.li variants={itemVariants}>
        <StatCard
          title="Bounties left for Today"
          total={tasksLeft.toString()} // Displays 0.000000 SOL if no payout
          currency={false}
        >
          <div className="flex justify-start w-full items-start">
            <div className="bg-gray-600 p-2 rounded-full">
      ...
      <motion.li variants={itemVariants} className="md:hidden">
        <StatCard
          title="Reputation"
          total={reputation.toString()+" %"} // Displays 0.000000 SOL if no payout
          currency={false}
        >
          <div className="flex justify-start w-full items-start">
            <div className="bg-gray-600 p-2 rounded-full">
