    ...
    >
      ...
      <motion.li variants={itemVariants}>
        <StatCard
          ...
          total={formattedEarned} // Displays 0.000000 SOL if no earnings
          rate={rate}
          levelUp={levelUp}
          levelDown={levelDown}
        >
      ...
      <motion.li variants={itemVariants}>
        <StatCard
          title="Total Payout"
          total={formattedPayout} // Displays 0.000000 SOL if no payout
          rate={""} // Empty rate for payout stat
        >
          <div className="flex justify-start w-full items-start">
            <div className="bg-gray-600 p-2 rounded-full">
              <svg
